...
from datasets.coco.coco_input_pipeline import COCOInputPipeline
from datasets.data_factory import RegisterInputPipeline
import tensorflow as tf


@RegisterInputPipeline('coco-noisy')
class NoisyCOCOInputPipeline(COCOInputPipeline):
    ...
    def preprocess_example(self, example, is_training, thread_id=0):
        data = super(NoisyCOCOInputPipeline, self).preprocess_example(
